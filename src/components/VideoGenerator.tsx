...
//   // Generate video from n8n webhook
...
//         "https://bhumee.app.n8n.cloud/webhook-test/video-generate",
//         {
//           method: "POST",
...
//       // Backend returns JSON with video URL
...
//       setPosterUrl(""); // optional: clear poster if you want
//       setShowPreview(true);
//     } catch (err) {
//       console.error(err);
